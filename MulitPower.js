...
var init = () => {
    ...
    // c1
    {
        ...
        c1 = theory.createUpgrade(0, currency, new FirstFreeCost(new ExponentialCost(15, Math.log2(10))));
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(1, currency, new FirstFreeCost(new ExponentialCost(1e100, Math.log2(1))));
    ...
    // c3
    {
        ...
        c3 = theory.createUpgrade(2, currency2, new FirstFreeCost(new ExponentialCost(10000000, Math.log2(1))));
...
var tick = (elapsedTime, multiplier) => {
    ...
    currency.value *= getC1(c1.level) * currency2.pow(10);
    currency2.value = getC2(c2.level)
    if (c3.level > 0) {
        currency2.value *= BigNumber.from(10);
    }
}
...
var getC3 = (level) => BigNumber.from(0);
